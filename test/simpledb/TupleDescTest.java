...
public class TupleDescTest extends SimpleDbTestBase
{
	 ...
	 * names
	 */
	private boolean combinedStringArrays(TupleDesc td1, TupleDesc td2,
			TupleDesc combined)
	{
		...
		{
			if (!(((td2.getFieldName(i - td1.numFields()) == null) && (combined
					.getFieldName(i) == null)) || td2.getFieldName(
					i - td1.numFields()).equals(combined.getFieldName(i))))
			{
				return false;
			}
		}
	...
	public void testEquals()
	{
		...
		TupleDesc intString = new TupleDesc(new Type[] { Type.INT_TYPE,
				Type.STRING_TYPE });

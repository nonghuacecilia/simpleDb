...
public class EvictionTest extends SimpleDbTestBase
{
	...
	@Test
	public void testHeapFileScanWithManyPages() throws IOException,
			DbException, TransactionAbortedException
	{
		System.out.println("EvictionTest creating large table");
		HeapFile f = SystemTestUtil.createRandomHeapFile(2, 1024 * 500, null,
				null);
		...
		System.out
				.println("EvictionTest scan complete, testing memory usage of scan");

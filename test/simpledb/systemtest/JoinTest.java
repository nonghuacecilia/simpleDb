...
public class JoinTest extends SimpleDbTestBase
{
	...
	public void validateJoin(int table1ColumnValue, int table1Rows,
			int table2ColumnValue, int table2Rows) throws IOException,
	...
	@Test
	public void testSingleMatch() throws IOException, DbException,
	...
	@Test
	public void testNoMatch() throws IOException, DbException,
			TransactionAbortedException
	{
	...
	@Test
	public void testMultipleMatch() throws IOException, DbException,
			TransactionAbortedException
	{

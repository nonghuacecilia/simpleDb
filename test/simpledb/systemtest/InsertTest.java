...
public class InsertTest extends SimpleDbTestBase
{
			...
			throws DbException, IOException, TransactionAbortedException
	{
		...
		HeapFile source = SystemTestUtil.createRandomHeapFile(columns,
				sourceRows, null, sourceTuples);
		assert sourceTuples.size() == sourceRows;
		ArrayList<ArrayList<Integer>> destinationTuples = new ArrayList<ArrayList<Integer>>();
		HeapFile destination = SystemTestUtil.createRandomHeapFile(columns,
				destinationRows, null, destinationTuples);
		...
		while (q.hasNext())
		{
			...
			hasResult = true;
			assertEquals(SystemTestUtil.SINGLE_INT_DESCRIPTOR,
					tup.getTupleDesc());
	...
	@Test
	public void testEmptyToEmpty() throws IOException, DbException,
	...
	@Test
	public void testEmptyToOne() throws IOException, DbException,
			TransactionAbortedException
	{
	...
	@Test
	public void testOneToEmpty() throws IOException, DbException,
			TransactionAbortedException
	{
	...
	@Test
	public void testOneToOne() throws IOException, DbException,
			TransactionAbortedException
	{

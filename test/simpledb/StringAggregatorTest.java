...
public class StringAggregatorTest extends SimpleDbTestBase
{
	...
	{
		this.scan1 = TestUtil.createTupleList(width1, new Object[] { 1, "a", 1,
				"b", 1, "c", 3, "d", 3, "e", 3, "f", 5, "g" });
	...
	{
		scan1.open();
		StringAggregator agg = new StringAggregator(0, Type.INT_TYPE, 1,
				Aggregator.Op.COUNT);
	...
	public void testIterator() throws Exception
	{
		...
		try
		{
			it.next();
			throw new Exception(
					"StringAggreator iterator yielded tuple after close");
		} catch (Exception e)
		{
			// explicitly ignored
		}

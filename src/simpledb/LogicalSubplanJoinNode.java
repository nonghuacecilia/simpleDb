...
public class LogicalSubplanJoinNode extends LogicalJoinNode
{
	...
	public LogicalSubplanJoinNode(String table1, String joinField1,
			DbIterator sp, Predicate.Op pred)
	{
		t1 = table1;
		f1 = joinField1;
		subPlan = sp;
	...
	public boolean equals(Object o)
	{
		...
		return (j2.t1.equals(t1) && j2.f1.equals(f1) && ((LogicalSubplanJoinNode) o).subPlan
				.equals(subPlan));
	}

	public LogicalSubplanJoinNode swapInnerOuter()
	{
		LogicalSubplanJoinNode j2 = new LogicalSubplanJoinNode(t1, f1, subPlan,
				p);
		return j2;
	}
